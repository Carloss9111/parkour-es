...
execute if score #current_map mm_value matches 12 run tellraw @s ["",{"text":"Parkour Volcano: ","bold":true,"color":"white"},{"text":"[LINK]","color":"blue","clickEvent":{"action":"open_url","value":"https://hielkemaps.com/maps/parkour-volcano"},"hoverEvent":{"action":"show_text","value":["",{"text":"https://hielkemaps.com/maps/parkour-volcano","color":"gray"}]}}]