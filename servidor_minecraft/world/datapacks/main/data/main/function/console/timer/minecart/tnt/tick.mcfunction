...
execute as @e[type=minecart,tag=tnt_minecart] at @a[gamemode=!spectator] if entity @s[distance=..0.87] run function main:console/timer/minecart/tnt/explode

execute as @e[type=minecart,tag=tnt_minecart] at @s run function main:console/timer/minecart/tnt/motion
