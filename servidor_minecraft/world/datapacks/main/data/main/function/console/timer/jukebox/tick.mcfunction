item replace entity @e[type=chest_minecart,x=-12,y=95,z=66,dx=0,dy=0,dz=0] container.13 with music_disc_stal[can_place_on={predicates:[{blocks:"jukebox"}],show_in_tooltip:false}]
